...
{ id:'t17', day:9, from:'Mom', time:'07:20', body:`If you leave in the morning you'd be here for dinner.

I have made the thing you like. It will keep.` },
{ id:'t18', day:10, from:'Mom', time:'06:00', body:`Is Ray with you` },
{ id:'t19', day:10, from:'Mom', time:'06:02', body:`Baby is Ray with you` },
{ id:'t20', day:10, from:'Court', time:'13:30', body:`she asked me to ask you again about ray

im not going to ask. just so you know shes asking` },
{ id:'t21', day:11, from:'Dad', time:'04:44', body:`I am not going to sleep until you answer.

I am not saying that to be dramatic. I am saying it because it is what is happening.` },
{ id:'t22', day:11, from:'Mom', time:'18:00', body:`They said do not respond to voices

Whose voices` },
{ id:'t23', day:12, from:'Court', time:'02:10', body:`I looked up how far you are from I-64

its four minutes. its FOUR MINUTES to the ramp

please` },
{ id:'t24', day:12, from:'Mom', time:'19:50', body:`I keep the porch light on. I know it doesn't help. I know you can't see it.

I keep it on.` },
{ id:'t25', day:13, from:'Dad', time:'11:11', body:`Truck's still packed.` },
{ id:'t26', day:13, from:'Mom', time:'21:00', body:`Sent` , failed:true },
{ id:'t27', day:14, from:'Court', time:'08:00', body:`nothing is going through. this might not go through

if it does: get in the car` , failed:true },
{ id:'t28', day:14, from:'Mom', time:'22:30', body:`` , failed:true },
{ id:'t29', day:15, from:'Mom', time:'—', body:`` , failed:true, empty:true },
];
...
export const REPLIES = [
  ...
  { id:'r_lie',   day:9,  label:`"we're stocked up. we're fine. go to bed."` },
  { id:'r_ray2',  day:10, label:`"ray's out getting stuff. he's fine."`, cost:'habitation' },
  { id:'r_true',  day:11, label:`"i don't know what to tell you."` },
  { id:'r_love',  day:13, label:`"i love you. tell dad to unpack the truck."` },
];
...
It stays open for forty seconds and then it ends. It was not hung up. It ended.` },
  { stage:4, day:14, result:'picked up',
...
You do not say his name this time. You listen for a minute and eleven seconds and then you take the phone away from your ear and look at it, and the call is still going, and you end it yourself.` },
  { stage:5, day:15, result:'picked up',
...
{ day:13, voice:'Ray', body:`Somebody is calling your name from the street.
...
{ day:14, voice:'Mom', body:`It is your mother's voice.
