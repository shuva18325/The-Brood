...
export const SIGHTINGS = [
  ...
  { day:9, city:'Norfolk',    loc:'Berkley',                type:'BIG — collapse x2',         date:'—', time:'02:10', src:'berkley_dan',ver:'no',  notes:'long gaps both' },
  { day:9, city:'Norfolk',    loc:'Hampton Blvd',           type:'water',                     date:'—', time:'12:50', src:'video v07',  ver:'yes', notes:'4 blocks. daylight. one loss on camera.' },
  { day:10,city:'Norfolk',    loc:'Berkley',                type:'VOICE',                     date:'—', time:'21:00', src:'berkley_dan',ver:'no',  notes:'2hrs. neighbour\'s name. neighbour in GA.' },
  { day:11,city:'Norfolk',    loc:'Larchmont',              type:'INSIDE — writing',          date:'—', time:'—',     src:'stillwaters',ver:'no',  notes:'note in dead relative\'s hand' },
  { day:12,city:'Norfolk',    loc:'22nd St',                type:'VOICE',                     date:'—', time:'04:02', src:'video v10',  ver:'yes', notes:'41 calls. a door opened.' },
  { day:12,city:'Norfolk',    loc:'Park Place',             type:'scavengers',                date:'—', time:'23:40', src:'mudflat',    ver:'no',  notes:'means the big one already came through' },
  { day:13,city:'Norfolk',    loc:'Berkley',                type:'INSIDE — writing',          date:'—', time:'04:44', src:'berkley_dan',ver:'yes', notes:'INSIDE of his door.' },
  { day:14,city:'Norfolk',    loc:'Ocean View',             type:'water — total',             date:'—', time:'—',     src:'oysterknife',ver:'yes', notes:'15th is water now. the land.' },
];
...
export const IMPACTS = [
  ...
  { day:9,  route:'I-64 W',   mp:'MP 243', vehicle:'semi',         ts:'d-7 03:00',  ver:3, outcome:'MADE IT. this is the semi everyone talks about.' },
  { day:9,  route:'I-64 W',   mp:'MP 243', vehicle:'semi',         ts:'d-6 15:45',  ver:2, outcome:'no. second semi. nothing.' },
  { day:9,  route:'I-664 N',  mp:'MP 4',   vehicle:'box truck',    ts:'d-6 22:00',  ver:1, outcome:'made it' },
  { day:10, route:'US-58 W',  mp:'county', vehicle:'MRAP (Guard)', ts:'d-5 02:10',  ver:3, outcome:'OFF THE ROAD ~6 HOURS. back on 58 by 08:00.' },
  { day:10, route:'US-58 W',  mp:'county', vehicle:'MRAP (Guard)', ts:'d-4 21:30',  ver:2, outcome:'no effect at all. second MRAP.' },
  { day:10, route:'I-64 W',   mp:'MP 205', vehicle:'box truck',    ts:'d-4 10:00',  ver:1, outcome:'made it — went 45 min after a logged impact' },
  { day:11, route:'I-264 W',  mp:'MP 9',   vehicle:'bus',          ts:'d-3 16:20',  ver:2, outcome:'made it' },
  { day:11, route:'I-64 W',   mp:'MP 220', vehicle:'bus',          ts:'d-2 06:00',  ver:1, outcome:'no.' },
  { day:12, route:'US-17 N',  mp:'—',      vehicle:'box truck',    ts:'d-2 19:40',  ver:2, outcome:'made it, 2 hrs after' },
  { day:12, route:'I-64 W',   mp:'MP 238', vehicle:'sedan',        ts:'d-1 08:30',  ver:1, outcome:'no. sedans have been dead for a week.' },
  { day:13, route:'US-58 W',  mp:'—',      vehicle:'tractor',      ts:'d-1 22:00',  ver:2, outcome:'made it. 3 hrs after.' },
  { day:14, route:'I-64 W',   mp:'MP 238', vehicle:'box truck',    ts:'today 04:10',ver:2, outcome:'unknown — no callback yet' },
  { day:15, route:'I-64 W',   mp:'MP 238', vehicle:'—',            ts:'—',          ver:0, outcome:'no new rows. sheetmom last edited 19:20 yesterday.' },
];
...
export const FLOODING = [
  ...
  { day:9,  road:'Chesapeake Bay Bridge-Tunnel',            status:'CLOSED',    note:'not water. "structural assessment."' },
  { day:9,  road:'Colonial Ave, Ghent, 2 blocks',           status:'CLOSED',    note:'' },
  { day:10, road:'Little Creek Rd, E of Tidewater',         status:'CLOSED',    note:'' },
  { day:11, road:'Terminal Blvd',                           status:'CLOSED',    note:'' },
  { day:11, road:'I-564 (both directions)',                 status:'CLOSED',    note:'base access. water at the gate.' },
  { day:12, road:'Brambleton Ave, E of Colley',             status:'CLOSED',    note:'' },
  { day:13, road:'Church St, N of Virginia Beach Blvd',     status:'CLOSED',    note:'' },
  { day:13, road:'22nd St, W of Granby',                    status:'CLOSED',    note:'one block from where the voice was' },
  { day:14, road:'Ocean View Ave (entire)',                 status:'GONE',      note:'sheetmom changed the wording. she was asked to change it back. she has not.' },
  { day:14, road:'I-264 E of Ballentine',                   status:'CLOSED',    note:'westbound still open as of this morning' },
];
...
export const CITIES = [
  ...
  { day:9,  city:'Norfolk, VA (upd)',commons:'high',     big:'1–2', inside:'1+', red:'?', other:'water, voices',
    note:'"?" on the red column does not mean no. you cannot check for the red one remotely because the only sign is silence.' },
  { day:12, city:'Richmond, VA',    commons:'none',      big:'0',   inside:'0',  red:'0', other:'—',
